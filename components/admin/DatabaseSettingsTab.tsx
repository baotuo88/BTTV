        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            <button
              onClick={fetchStatus}
              disabled={loading}
              className="px-4 py-2 bg-[#333] hover:bg-[#444] text-white text-sm rounded-lg transition flex items-center justify-center gap-2 disabled:opacity-50"
            >
            ...
            <button
              ...
              disabled={testing}
              className="px-4 py-2 bg-[#E50914] hover:bg-[#B20710] text-white text-sm rounded-lg transition flex items-center justify-center gap-2 disabled:opacity-50"
            >
              {testing ? (
                <>
