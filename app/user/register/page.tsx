    ...
    <div className="min-h-screen flex items-center justify-center bg-[#141414]">
      <div className="w-full max-w-md px-6">
        <div className="bg-[#1a1a1a] rounded-lg shadow-2xl p-10 border border-[#333]">
          ...
          {!operationsConfig.allowRegister && (
            <div className="mb-5 bg-[#333]/40 border border-[#555] rounded p-3 text-[#c7c7c7] text-sm">
              当前站点已关闭新用户注册
            </div>
          )}
          ...
          <form onSubmit={onSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading || !operationsConfig.allowRegister}
